...
include { MERGE_VCF_COLUMNS                              } from '../../modules/nf-core/mergevcfcolumns_mt/main'
...
workflow ANNOTATE_MT_SNVS {
    ...
    main:
        ...
        ch_mt_vcf_tbi = ch_mt_vcf.join(ch_mt_tbi)
        MERGE_VCF_COLUMNS (ENSEMBLVEP_MT.out.tab,ch_mt_vcf_tbi)
        
        TABIX_TABIX_VEP_MT(MERGE_VCF_COLUMNS.out.cleaned_output)
    ...
    emit:
        ...
        vcf_ann   = MERGE_VCF_COLUMNS.out.cleaned_output          // channel: [ val(meta), path(vcf) ]
