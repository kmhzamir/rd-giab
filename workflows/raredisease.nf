...
//include { CAT_CAT                               } from '../modules/nf-core/bcftools/concat_tab/main'
include { CSVTK_CONCAT                          } from '../modules/nf-core/csvtk/main'
include { CREATE_HGNCIDS_FILE                   } from '../modules/local/create_hgncids_file'
include { TABIX_TABIX as TABIX_TABIX_SNV_MITO   } from '../modules/nf-core/tabix/tabix/main'
